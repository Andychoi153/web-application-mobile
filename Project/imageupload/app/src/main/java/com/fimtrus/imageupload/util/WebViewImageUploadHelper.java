package com.fimtrus.imageupload.util;
...
import com.fimtrus.imageupload.activity.MainActivity;
import com.fimtrus.imageupload.model.Constant;
...
//				KITKAT_FILECHOOSER);
	...
	public void callCamera(int requestCode) {
		...
		mTempFile = new File(directory, "photo_" + new Date().getTime() + ".dat");
